...
const programBlocks = [
	...
	},
	{
		...
		items: [
			...
			"14:15–14:20 Танец Стерхов",
			"14:20–14:25 Хомус",
			"14:25–14:30 Флэшмоб",
			"14:30–14:35 Оhуохай (Осуохай)",
		],
		icon: Flame,
		tag: "Главное событие",
	...
	},
	{
		...
		label: "Игры",
		title: "Игры Дыгына",
		desc: "Традиционные якутские состязания для мужчин: хапсагай, мас-рестлинг и хаамыска (перетаскивание камня). Девушки участвуют только в мас-рестлинге. Дух соревнования и веселья!",
		items: [
			"16:10–16:50 Хапсаҕай (борьба)",
			"17:00–17:30 Мас тардыhыы (мас-рестлинг)",
			"17:40–18:30 Хаамыска (перетаскивание камня)",
		],
		icon: Dumbbell,
		tag: "Соревнования",
