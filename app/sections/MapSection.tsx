...
const tips = [
	{
		title: "Дресс-код",
		text: "Национальная одежда, белые или кремовые лёгкие наряды изо льна и ситца.",
	},
	{
		title: "Что взять с собой",
		text: "Солнцезащитные очки, коврик для хоровода, головной убор.",
	},
	{
		title: "Для детей",
		text: "Тенистый детский уголок с играми, аниматорами и питьевой водой.",
	},
	{
		title: "Сборные игры",
		text: "Записаться на мас-рестлинг можно на месте или через форму ниже.",
	},
];
